...
var KTCustomersList = function () {
  var t,
      ...
      n,
      c = function c() {
    n.querySelectorAll('[data-kt-customer-table-filter="delete_row"]').forEach(function (e) {
      ...
      r = function r() {
    var e = n.querySelectorAll('[type="checkbox"]'),
  ...
  var l = function l() {
    var t = document.querySelector('[data-kt-customer-table-toolbar="base"]'),
  ...
  return {
    init: function init() {
      (n = document.querySelector("#kt_customers_table")) && (n.querySelectorAll("tbody tr").forEach(function (t) {
      ...
      }), e = $('[data-kt-customer-table-filter="month"]'), o = document.querySelectorAll('[data-kt-customer-table-filter="publish_type"] [name="publish_type"]'), document.querySelector('[data-kt-customer-table-filter="filter"]').addEventListener("click", function () {
        var n = e.val();
        var c = "";
