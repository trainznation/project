        ...
        action.addEventListener('click', (e) => {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    modal.find('.modal-body').html(`<p>${data.description}</p><br /><strong>Catégorie:</strong> ${data.category.name}`)
        ...
        action.addEventListener('click', (e) => {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    modal.find('[name="project_task_category_id"]').html(`<option value="${data.category.id}">${data.category.name}</option>`)
