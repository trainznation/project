            ...
            <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                ...
                <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                    ...
                    <a href="index.html" class="py-9">
                        <img alt="Logo" src="media/core/logo_icon_couleur.png" class="h-70px" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Title-->
                    ...
                    <!--end::Title-->
                    <!--begin::Description-->
                    <p class="fw-bold fs-2" style="color: #986923;">Gestionnaire de projet</p>
                    <!--end::Description-->
                </div>
                <!--end::Content-->
                <!--begin::Illustration-->
                <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px" style="background-image: url(media/core/train_vector.png)"></div>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
        </div>
                ...
                <div class="w-lg-500px p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" action="{{ route('login') }}" method="post">
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">Connexion au portail</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                            <!--end::Link-->
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="form-label fs-6 fw-bolder text-dark">Adresse Mail</label>
                            <!--end::Label-->
                            <!--begin::Input-->
