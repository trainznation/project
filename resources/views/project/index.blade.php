        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Rechercher un projet" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
                ...
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Icons</th>
                    <th class="min-w-125px">Titre</th>
                    <th class="min-w-125px">Taches</th>
                    <th class="min-w-125px">Publication</th>
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            </span> Taches: {{ $project->tasks()->count() }}<br>
                            {!! stateProgressStateTask($project->id) !!}
                        </td>
                        <!--end::Company=-->
                        <!--begin::Payment method=-->
                        <td data-filter="{{ statePublishProject($project->published, true) }}">
                            {!! statePublishProject($project->published) !!}
                        </td>
                        <!--end::Payment method=-->
                        <!--begin::Date=-->
                        <td data-filter="{{ stateLabelProject($project->state, true) }}">
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-200px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                    <a href="#" class="menu-link px-3" data-kt-customer-table-filter="delete_row">Supprimer le projet</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu-->
