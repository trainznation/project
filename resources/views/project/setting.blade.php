...
@section("content")
    ...
    <div class="card shadow-sm bg-danger">
        <div class="card-header">
            <h3 class="card-title text-white">Danger Zone</h3>
        </div>
        <div class="card-body bg-secondary">
            <div class="d-flex justify-content-between">
                <div>
                    <strong>Supprimer le projet</strong><br>
                    <i>La suppression est irréversible, aucun retour n'est possible</i>
                </div>
                <div>
                    <button class="btn btn-outline btn-outline-danger" data-bs-toggle="modal" data-bs-target="#modal_delete_project">Supprimer le projet</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" tabindex="-1" id="modal_delete_project">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Etes-vous absolument sùr ?</h5>
                    ...
                    <div class="modal-body">
                        <div class="alert alert-warning d-flex align-items-center p-5 mb-10">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <span>De mauvaises choses inattendues vont se produire si vous ne lisez pas ceci !</span>
                            </div>
                        </div>
                        <p>Cette action ne peut pas être annulée. Cette action supprimera définitivement le projet <strong>{{ $project->title }}</strong> </p>
                        <p>Veuillez taper <strong>{{ $project->title }}</strong> pour confirmer.</p>
                        <input type="text" class="form-control" name="title" required />
                    </div>

                    <div class="modal-footer d-flex align-items-center">
                        <button type="submit" class="btn btn-outline btn-outline-danger">Je comprend les risques, supprimer le projet.</button>
                    </div>
                </form>
            </div>
        </div>
